...
const ProductCard: React.FC<ProductCardProps> = ({ data }) => {
  ...
  return (
    <div
      ...
      className="col-span-1 cursor-pointer border-[1.2px] border-slate-700 bg-slate-900/60 rounded-md p-2 transition hover:scale-110 active:scale-105 duration-500 active:duration-200 hover:bg-slate-700 text-center text-sm"
    >
